...
namespace Api.Controllers
{
    public class PetController : BaseApiController
    {
        ...
        public async Task<ActionResult> Create(ResponsePetModal newPet)
        {
            Pet pet = new Pet
            {
                Name = newPet.Name,
        ...
        public async Task<ActionResult> Update(Guid id, UpdatePetModal updatePet)
        {
            if (id != updatePet.Id)
            {
                return BadRequest();
        ...
        [HttpGet]
        [SwaggerOperation(Summary = "Get all pet")]
        public ActionResult GetAll()
        {
            List<Pet> listPets = _service.GetAll();
